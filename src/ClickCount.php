...
class ClickCount extends ApiResource 
{
    /**
     ...
     * @var string
     */
    const RESOURCE_PATH = 'analytics/clicks';

    /**
     * Get click count with specific params
     *
    ...
    {   
        $responseBody = self::_staticPost(ClickCount::RESOURCE_PATH, null, $body, false);
    ...
    /**
     * Maps properties from API to new click count result
     *
     * @param array $body 
     * @return int
     */
