...
class ClickUserCount extends ApiResource 
{
    /**
     ...
     * @var string
     */
    const RESOURCE_PATH = 'analytics/click-users';

    /**
     * Get click user with specific params
     *
    ...
    {   
        $responseBody = self::_staticPost(ClickUserCount::RESOURCE_PATH, null, $body, false);
    ...
    /**
     * Maps properties from API to new click user result
     *
     * @param array $body 
     * @return int
     */
