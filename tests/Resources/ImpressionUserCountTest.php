...
class ImpressionUserCountTest extends TestCase {

    /**
      * Test receiving a single impression user count (no aggregations)
      *
      * @return void
      */
    ...
    {   
        ...
        // Get the impression user count
        $count = ImpressionUserCount::get([
            'campaign_ids' => [1, 2, 3],
    ...
    /**
      * Test receiving an aggregated impression user count
      *
      * @return void
      */
    ...
    {   
        ...
        // Get the impression user count
        $counts = ImpressionUserCount::get([
            'campaign_ids' => [1, 2, 3],
            'advertiser_ids' => [1, 2, 3],
            'placement_ids' => [1, 2, 3],
            'is_desktop' => true,
